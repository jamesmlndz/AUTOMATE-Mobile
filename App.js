  ...
  return (
    <NavigationContainer>
      <Stack.Navigator screenOptions={{ headerShown: false }}>
        ...
        <Stack.Screen name="UpcomingAppointment" component={UpcomingAppointments} />
        <Stack.Screen name="HistoryAppointment" component={HistoryAppointments} />
        ...
        <Stack.Screen name="UnderchasisSuspension" component={UnderchasisSuspension} />
