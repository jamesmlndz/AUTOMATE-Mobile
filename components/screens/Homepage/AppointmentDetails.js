    ...
    <View style ={AppointmentDetailsStyles.container}>
      ...
      <View style={AppointmentDetailsStyles.detailsContainer}>
        ...
        <View style={AppointmentDetailsStyles.infoContainer}>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.name}</Text>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.phone}</Text>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.email}</Text>
        </View>

        {/* Car Section */}
        <Text style={AppointmentDetailsStyles.sectionHeader}>CAR</Text>
        <View style={AppointmentDetailsStyles.carContainer}>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.car}</Text>
          <Text style={AppointmentDetailsStyles.plateNumber}>{appointment.plate}</Text>
        </View>

        {/* Schedule Section */}
        <Text style={AppointmentDetailsStyles.sectionHeader}>SCHEDULE</Text>
        <View style={AppointmentDetailsStyles.infoContainer}>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.date}</Text>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.time}</Text>
        </View>

        {/* Service Section */}
        <Text style={AppointmentDetailsStyles.sectionHeader}>SERVICE</Text>
        <View style={AppointmentDetailsStyles.infoContainer}>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.service}</Text>
        </View>

        {/* Description Section */}
        <Text style={AppointmentDetailsStyles.sectionHeader}>DESCRIPTION</Text>
        <View style={AppointmentDetailsStyles.infoContainer}>
          <Text style={AppointmentDetailsStyles.infoText}>{appointment.description || "None"}</Text>
        </View>
      </View>
    </View>
  );
