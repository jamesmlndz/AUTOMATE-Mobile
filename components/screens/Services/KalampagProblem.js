  ...
  return (
    <ImageBackground source={require('../../../assets/automatebg.jpg')} style={styles.background} resizeMode="cover">
      <View style={styles.container}>
        ...
        <Image source={require('../../../assets/services/Kalampag.jpg')} style={styles.serviceImage} />

        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Kalampag Problem</Text>
          ...
          <Text style={styles.description}>
            This service identifies and resolves <Text style={styles.highlight}>squeaks or rattles</Text> coming from under your car for a smoother ride.
          </Text>
        </View>

        <Text style={styles.inquiryHeader}>Call for inquiries</Text>
        <View style={styles.inquiryCard}>
          <Image source={{ uri: 'https://i.ibb.co/QNnD2RJ/profile.png' }} style={styles.profileImage} />
