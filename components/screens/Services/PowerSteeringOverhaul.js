...
export default function PowerSteeringOverhaul() {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Image
          source={require('../../../assets/services/Power steering overhaul.jpg')}
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Power Steering Overhaul</Text>
          ...
          <Text style={styles.description}>
            Enjoy smooth and easy steering with our <Text style={styles.highlight}>power steering overhaul</Text> service. Fix leaks, replace worn components, and improve handling.
          </Text>
        </View>
