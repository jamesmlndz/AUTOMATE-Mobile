  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Image
          source={require('../../../assets/services/Wheel Balancing.jpg')}
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Wheel Balancing</Text>
          ...
          <Text style={styles.description}>
            Wheel balancing ensures the weight of the wheel and tire is evenly distributed. This service improves <Text style={styles.highlight}>driving stability</Text> and <Text style={styles.highlight}>tire longevity</Text>.
          </Text>
        </View>
