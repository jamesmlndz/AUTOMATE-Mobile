...
export default function BodyliftBodyLowered() {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Image
          source={require('../../../assets/services/BodyLift.jpg')}
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Bodylift / Body Lowered</Text>
          ...
          <Text style={styles.description}>
            Enhance your vehicle's appearance or clearance with <Text style={styles.highlight}>professional body lift</Text> or lowering service tailored to your needs.
          </Text>
        </View>
