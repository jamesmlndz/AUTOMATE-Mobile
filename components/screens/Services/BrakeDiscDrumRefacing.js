...
export default function BrakeDiscDrumRefacing() {
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Image
          source={require('../../../assets/services/BrakeDisc.jpg')}
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Brake Disc / Drum Refacing</Text>
          ...
          <Text style={styles.description}>
            Restore optimal braking performance with our <Text style={styles.highlight}>brake disc and drum refacing</Text> service. Ensures safe and smooth stops.
          </Text>
        </View>
