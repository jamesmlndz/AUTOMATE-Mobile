...
export default function CheckEngineScanning() {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Check Engine Scanning</Text>
          ...
          <Text style={styles.description}>
            A professional scan identifies <Text style={styles.highlight}>engine issues quickly</Text> using diagnostic tools to help restore proper vehicle function.
          </Text>
        </View>
