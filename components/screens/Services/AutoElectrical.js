  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Image
          source={require('../../../assets/services/Auto electrical.jpg')}
        ...
        <View style={styles.infoCard}>
          <View style={styles.cardHeader}>
            <View>
              <Text style={styles.serviceTitle}>Auto Electrical</Text>
          ...
          <Text style={styles.description}>
            We diagnose and repair <Text style={styles.highlight}>automotive electrical systems</Text> including lights, wiring, and charging components.
          </Text>
        </View>
